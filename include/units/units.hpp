...
// holds a float value. The class SHOULD NOT BE INSTANTIATED directly by itself,
// rather use the quantity types defined below.
...
class RQuantity {
 ...
 public:
  ...
  [[nodiscard]] constexpr float getValue() const { return value; }
};
...
template <typename M, typename L, typename T, typename A>
constexpr RQuantity<M, L, T, A> operator*(const float& lhs,
                                          const RQuantity<M, L, T, A>& rhs) {
...
constexpr QVelocity operator"" _inchs(long double x) {
  return static_cast<float>(x) * inch / second;
};
constexpr QVelocity operator"" _inchs(unsigned long long int x) {
  return static_cast<float>(x) * inch / second;
};
...
constexpr QAcceleration operator"" _mps2(unsigned long long int x) {
  return QAcceleration(static_cast<float>(x));
};
constexpr QAcceleration operator"" _inchs2(long double x) {
  return static_cast<float>(x) * inchs2;
};
constexpr QAcceleration operator"" _inchs2(unsigned long long int x) {
  return static_cast<float>(x) * inchs2;
};
constexpr QAcceleration operator"" _G(long double x) {
  return static_cast<float>(x) * G;
};
...
constexpr QForce operator"" _Newton(unsigned long long int x) {
  return QForce(static_cast<float>(x));
};
constexpr QForce operator"" _lbf(long double x) {
  return static_cast<float>(x) * poundforce;
};
constexpr QForce operator"" _lbf(unsigned long long int x) {
  return static_cast<float>(x) * poundforce;
};
constexpr QForce operator"" _kp(long double x) {
  return static_cast<float>(x) * kilopond;
};
...
constexpr QPressure operator"" _bar(long double x) {
  return static_cast<float>(x) * bar;
};
...
constexpr QPressure operator"" _psi(long double x) {
  return static_cast<float>(x) * psi;
};
...
constexpr Angle operator"" _rad(unsigned long long int x) {
  return Angle(static_cast<float>(x));
};
constexpr Angle operator"" _deg(long double x) {
  return static_cast<float>(x) * degree;
};
...
constexpr QCurvature operator"" _radm(long double x) {
  return static_cast<float>(x);
};
constexpr QCurvature operator"" _radm(unsigned long long int x) {
  return static_cast<float>(x);
};
constexpr QCurvature operator"" _degm(long double x) {
  return static_cast<float>(x) * DegM;
};
constexpr QCurvature operator"" _degm(unsigned long long int x) {
  return static_cast<float>(x) * DegM;
};
constexpr QCurvature operator"" _radin(long double x) {
  return static_cast<float>(x) * RadIn;
};
constexpr QCurvature operator"" _radin(unsigned long long int x) {
  return static_cast<float>(x) * RadIn;
};
constexpr QCurvature operator"" _degin(long double x) {
  return static_cast<float>(x) * DegIn;
};
constexpr QCurvature operator"" _degin(unsigned long long int x) {
  return static_cast<float>(x) * DegIn;
};
...
template <typename M, typename L, typename T, typename A>
constexpr RQuantity<M, L, T, A> Qabs(const RQuantity<M, L, T, A>& num) {
  return RQuantity<M, L, T, A>(fabs(num.getValue()));
}

// Typesafe mathematical operations:
// ---------------------------------
template <typename M, typename L, typename T, typename A>
constexpr RQuantity<std::ratio_divide<M, std::ratio<1, 2>>,
                    std::ratio_divide<L, std::ratio<1, 2>>,
                    std::ratio_divide<T, std::ratio<1, 2>>,
                    std::ratio_divide<A, std::ratio<1, 2>>>
Qsq(const RQuantity<M, L, T, A>& num) {
  return RQuantity<std::ratio_divide<M, std::ratio<1, 2>>,
                   std::ratio_divide<L, std::ratio<1, 2>>,
                   std::ratio_divide<T, std::ratio<1, 2>>,
                   std::ratio_divide<A, std::ratio<1, 2>>>(num * num);
}

// Typesafe trigonometric operations
inline float sin(const Angle& num) { return sin(num.getValue()); }
inline float cos(const Angle& num) { return cos(num.getValue()); }

inline float tan(const Angle& num) { return tan(num.getValue()); }
}  // namespace units

...
/**
 * @brief WaitUntilCommand creates a command that ends once a condition is
 * finished (condition turns true). This command has no requirements.
 */
class WaitUntilCommand : public FunctionalCommand {
 public:
   ...
   *
   * @param is_finish The conditional to end with. Once it is true the command
   * will finish
   */

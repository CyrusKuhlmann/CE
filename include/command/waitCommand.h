...
/**
 * @brief Creates a \refitem Command with no requirements that finishes after a
...
class WaitCommand : public Command {
 ...
 public:
   ...
   */
  explicit WaitCommand(const units::QTime& duration) : duration(duration) {}

  /**
   * @brief Initializes the WaitCommand and sets the start time of the
   * WaitCommand
   */
